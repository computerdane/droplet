/* @ts-self-types="./nexrad_wasm.d.ts" */
 ...
 * @returns {object}
 */
export function decode(raw, key) {
 ...
 * @param {Function} emit
 * @param {Function} log
 * @param {number | null | undefined} hint_volume
 * @param {number | null | undefined} hint_time_ms
 * @param {Function} remember
 * @param {string | null} [prior_json]
 * @param {Map<any, any> | null} [prior_files]
 */
export function live(site, bucket, sleep, emit, log, hint_volume, hint_time_ms, remember, prior_json, prior_files) {
    const ptr0 = passStringToWasm0(site, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(prior_json) ? 0 : passStringToWasm0(prior_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    const ret = wasm.live(ptr0, len0, bucket, sleep, emit, log, isLikeNone(hint_volume) ? Number.MAX_SAFE_INTEGER : (hint_volume) >>> 0, !isLikeNone(hint_time_ms), isLikeNone(hint_time_ms) ? 0 : hint_time_ms, remember, ptr1, len1, isLikeNone(prior_files) ? 0 : addToExternrefTable0(prior_files));
    if (ret[1]) {
 ...
 * @param {string} volume_json
 * @param {Map<any, any>} files
 * @param {string} prior_json
 * @param {Map<any, any>} prior_files
 * @returns {any}
 */
export function redealias(volume_json, files, prior_json, prior_files) {
    const ptr0 = passStringToWasm0(volume_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(prior_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.redealias(ptr0, len0, files, ptr1, len1, prior_files);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {Array<any>}
 */
export function resolve_keys(site, at, from, to, bucket) {
    const ptr0 = passStringToWasm0(site, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    const ret = wasm.resolve_keys(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, bucket);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_get_40c339df148585d9: function(arg0, arg1) {
        ...
        __wbg_keys_b0907f88804976be: function(arg0) {
            const ret = arg0.keys();
            return ret;
        },
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nexrad_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
